...
mqttRespStatus mqttDRBGgen(
    mqttDRBG_t *drbg, mqttStr_t *out, mqttStr_t *extra_in
...
TEST_GROUP_RUNNER(mqttUtilRand) { // TODO: improve test cases
    RUN_TEST_CASE(mqttUtilRand, gen_uint);
    RUN_TEST_CASE(mqttUtilRand, gen_byte_seq);
}

TEST_GROUP_RUNNER(mqttUtilMathWrapper) { // TODO: improve test cases
