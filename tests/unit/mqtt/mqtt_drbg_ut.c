...
static int mock_mqttHashInitFn(mqttHash_t *md)
{
    return mock_hash_init_return_val;
}
...
static int mock_mqttHashDoneFn(mqttHash_t *md, byte *out)
{
    return mock_hash_done_return_val;
}
