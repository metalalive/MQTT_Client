...
class CodeGenerator:
    ...
    * function name mappings between the chosen middleware and the chosen third-party libraries
    ...
    def __init__(self, cfg_file_path, template_path, template_files, output_path, config_params):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cfg-path", required=True, help="path to the mqttclient.conf file")
