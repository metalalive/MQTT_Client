...
#define MQTT_CFG_MPBINT_FN_BIN2MPINT(mp_int_p, inbuf, size) \
    mp_from_ubin((mp_int_p), (inbuf), (size))
#define MQTT_CFG_MPBINT_FN_MPINT2BIN(mp_int_p, outbuf, size, nbytes_wr) \
    mp_to_ubin((mp_int_p), (outbuf), (size), (nbytes_wr))
