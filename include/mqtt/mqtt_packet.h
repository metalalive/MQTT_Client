...
// check allowable max packet size
    ...
    #else
        #error \
            "MQTT_PROTOCOL_PKT_MAXBYTES must NOT be smaller than defined MQTT_PLATFORM_PKT_MAXBYTES, recheck your configuration."
    #endif
    ...
    #else
        #error \
            "MQTT_SYS_PKT_MAXBYTES must NOT be smaller than defined MQTT_PLATFORM_PKT_MAXBYTES, recheck your configuration."
    #endif
#else
